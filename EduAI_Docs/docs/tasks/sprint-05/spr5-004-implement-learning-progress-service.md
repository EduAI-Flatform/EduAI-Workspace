# SPR5-004 — Implement Learning Progress Service
...
Implement lesson completion and course progress.
...
- [ ] Only enrolled student can complete
...
Task: SPR5-004 — Implement Learning Progress Service
