...
Add configurable attempt limits, question/option randomization, attempt history, and post-submission review rules.

## Deliverables

- Quiz policy migration and DTOs
- Attempt eligibility and history APIs
- Instructor configuration UI
- Student history and review UI

## Acceptance Criteria

- [ ] Correct answers are not exposed before submission
- [ ] Attempt limits are enforced server-side
- [ ] Randomization does not change scoring integrity
- [ ] Existing quizzes receive safe defaults
...
Task: SPR15-002 — Quiz Attempt Policy and History
