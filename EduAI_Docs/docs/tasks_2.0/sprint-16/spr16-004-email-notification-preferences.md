...
Add opt-in email delivery for assignment deadlines, grades, classroom reminders, and certificates.

## Deliverables

- Email provider abstraction
- Preference UI
- Retry-safe delivery records
- Templates and development preview

## Acceptance Criteria

- [ ] Transactional and optional emails are distinguished
- [ ] Users can disable optional categories
- [ ] Failures are logged without blocking core transactions
...
Task: SPR16-004 — Email Notification Preferences
