...
Add private mentor notes, shared next-step goals, and post-session learner reviews.

## Deliverables

- Private and shared note separation
...
- [ ] Private mentor notes are never returned to learners
- [ ] Reviews require a completed session
- [ ] Review edits follow an explicit policy
- [ ] Abuse reporting is supported or deferred explicitly
...
Task: SPR19-004 — Mentor Notes, Goals, and Reviews
