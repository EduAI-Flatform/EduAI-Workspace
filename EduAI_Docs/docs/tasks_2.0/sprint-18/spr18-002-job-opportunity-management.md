...
Implement admin-managed job opportunities with searchable public listings.

## Deliverables

- Job, required skill, and status schema
- Admin CRUD
- Student search/filter/detail UI
- Publication lifecycle

## Acceptance Criteria

- [ ] Only published active jobs are visible to students
...
Task: SPR18-002 — Job Opportunity Management
